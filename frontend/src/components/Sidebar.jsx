    ...
    return (
        <>
            ...
            >
                ...
                {/* قائمة التنقل */}
                <nav className="flex flex-col text-sm font-medium flex-grow overflow-auto">
                    {/* المستخدمون */}
                    <NavLink
                        to="/dashboard/users"
                        className={`flex items-center space-x-3 p-2 rounded-lg transition duration-300 mb-4 ${
                    ...
                    <button
                        ...
                        className={`flex items-center space-x-3 p-2 w-full rounded-lg transition duration-300 mb-4 ${
                    ...
                    <NavLink
                        to="/dashboard/orders"
                        className={`flex items-center space-x-3 p-2 rounded-lg transition duration-300 mb-4 ${
                            activeMainLink === "orders"
                                ? "bg-blue-600 text-white shadow-md"
                                : "hover:bg-gray-700 text-gray-300"
                        }`}
                        onClick={() => handleMainNavClick("orders")}
                    >
                        <FaBoxOpen className="text-lg rotate-90" />
            ...
            {showLogoutConfirm && (
                <div className="fixed inset-0 flex items-center justify-center bg-blue-100/80 backdrop-blur-sm z-50">
